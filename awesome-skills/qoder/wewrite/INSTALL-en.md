...
```bash
git clone --depth 1 https://github.com/oaker-io/wewrite.git ~/.qoder/wewrite
```
...
rm -rf ~/.qoder/skills/wewrite
ln -s ~/.qoder/wewrite ~/.qoder/skills/wewrite
```

### 3. Install Python Dependencies

```bash
cd ~/.qoder/wewrite && pip install -r requirements.txt
```
...
If successful, Qoder will automatically recognize and invoke the WeWrite skill.
