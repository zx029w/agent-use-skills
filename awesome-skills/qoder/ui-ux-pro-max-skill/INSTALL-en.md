# UI UX Pro Max - Qoder Installation Guide
...
After installation, try the following conversation in Qoder:
...
```bash
python3 .qoder/skills/ui-ux-pro-max/scripts/search.py "SaaS dashboard" --design-system --persist -p "MyApp"
```
...
```bash
rm -rf ~/.qoder/skills/ui-ux-pro-max-skill
```
