# 为 OpenCode 安装 multi-search-engine
...
创建符号链接，使 OpenCode 的原生技能工具能够发现 multi-search-engine 技能：
...
重启 OpenCode，插件将自动注入 multi-search-engine 上下文。

通过询问以下问题来验证是否安装成功："do you have multi-search-engine?"
