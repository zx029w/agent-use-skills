# UI UX Pro Max - Claude Code Installation Guide

## Installation Steps

### Method 1: Using Claude Marketplace (Recommended)

Execute the following two commands in Claude Code:
...
After installation, try the following conversation in Claude Code:
