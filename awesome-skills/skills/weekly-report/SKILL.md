...
- **Step 1**: 确认转换需求
  ...
  - 如 `工作周报-张三-03月10日-03月14日.md` → `工作周报-张三-03月10日-03月14日.docx`
  - 用户可以指定其他文件名或路径
...
**示例**:
```bash
scripts/md_to_docx.py 工作周报-张三-03月10日-03月14日.md 工作周报-张三-03月10日-03月14日.docx
```
...
**手动确认**:
- 获取日期后，向用户确认: "检测到周报日期为 03月10日-03月14日，是否正确？"
- 如果无法自动获取，询问: "请提供周报的时间范围（如：3月10日-3月14日）"
...
**输入**:
用户说："帮我把 工作周报-张三-03月10日-03月14日.md 转成 Word 文档"
...
```bash
python3 scripts/md_to_docx.py 工作周报-张三-03月10日-03月14日.md 工作周报-张三-03月10日-03月14日.docx
```

**输出**:
"已成功将 Markdown 转换为 Word 文档，保存在: 工作周报-张三-03月10日-03月14日.docx"
