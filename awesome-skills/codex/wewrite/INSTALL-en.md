...
```bash
git clone --depth 1 https://github.com/oaker-io/wewrite.git ~/.codex/wewrite
```
...
rm -rf ~/.codex/skills/wewrite
ln -s ~/.codex/wewrite ~/.codex/skills/wewrite
```

### 3. Install Python Dependencies

```bash
cd ~/.codex/wewrite && pip install -r requirements.txt
```
...
If successful, Codex will automatically recognize and invoke the WeWrite skill.
